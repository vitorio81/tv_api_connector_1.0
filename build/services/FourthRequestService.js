...
exports.FourthRequestService = void 0;
const env_1 = require("../config/env");
const axios_1 = __importDefault(require("axios"));
class FourthRequestService {
    static request(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = `${env_1.config.hostIntegration.toLowerCase()}/${env_1.config.typeFourthRequest.toLowerCase()}`;
            try {
...
exports.FourthRequestService = FourthRequestService;
